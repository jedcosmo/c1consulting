...
add_filter('siteorigin_widgets_icons_elegantline', 'siteorigin_widgets_icons_elegantline_filter');function siteorigin_widgets_icons_elegantlines_filter($icons) {
	return array(

		'arrow_up' => '&#x21;',
	);
}
add_filter('siteorigin_widgets_icons_elegantlines', 'siteorigin_widgets_icons_elegantlines_filter');

function siteorigin_widgets_icons_coneconsulting_filter($icons) {
	return array(
...
add_filter('siteorigin_widgets_icons_coneconsulting', 'siteorigin_widgets_icons_coneconsulting_filter');
...
function siteorigin_widgets_icon_families_filter( $families ){
	...
	$families['coneconsulting'] = array(
		'name' => __( 'c1 consulting', 'siteorigin-widgets' ),
		'style_uri' => plugin_dir_url(__FILE__).'C1consulting/style.css',
		'icons' => apply_filters( 'siteorigin_widgets_icons_coneconsulting', array() ),
	);
