<?php
/*
Widget Name: Extra Services widget
Description: Displays a block of services with icons.
Author: Sunil Chaulagain
Author URI: http://tuchuk.com
*/

class SiteOrigin_Widget_ExtraServices_Widget extends SiteOrigin_Widget {
	function __construct() {
		parent::__construct(
			'sow-extraservices',
			__( 'SiteOrigin Extra Services', 'siteorigin-widgets' ),
			array(
			...
			array(			
				...
				'icon_animation' => array(
					...
					'style' => array(
							...
							'options' => array(
								'1' => __('Extra Service Style 1 ', 'siteorigin-widgets'),
								'2' => __('Extra Service Style 2', 'siteorigin-widgets'),	
	...
	function initialize() {
		$this->register_frontend_styles(
			array(
				array(
					'siteorigin-extraservices',
					siteorigin_widget_get_plugin_dir_url( 'extraservices' ) . 'css/style.css',
					array(),
					SOW_BUNDLE_VERSION
				)
			)
...
siteorigin_widget_register('extraservices', __FILE__);