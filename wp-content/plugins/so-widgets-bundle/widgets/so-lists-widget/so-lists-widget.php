<?php
/*
Widget Name: Lists widget
Description: Displays lists with variety of bullets
Author: Sunil Chaulagain
Author URI: http://tuchuk.com
*/
class SiteOrigin_Widget_Lists_Widget extends SiteOrigin_Widget {
	function __construct() {
		parent::__construct(
			'sow-lists',
			__('SiteOrigin Lists', 'siteorigin-widgets'),
			array(
				'description' => __('A simple lists widget with different style.', 'siteorigin-widgets'),
			...
			array(
				'listitem' => array(
					'type' => 'repeater',
					'label' => __('Listitems', 'siteorigin-widgets'),
					'item_name' => __('Listitem', 'siteorigin-widgets'),
					'item_label' => array(
						'selector' => "[id*='columns-listitems-text']",
						'update_event' => 'change',
						'value_method' => 'val'
					),
					'fields' => array(
				...
				'style' => array(
					...
					'options' => array(
						'1' => __('List Style 1', 'siteorigin-widgets'),
						'2' => __('List Style 2', 'siteorigin-widgets'),
						'3' => __('List Style 3', 'siteorigin-widgets'),
						'4' => __('List Style 4', 'siteorigin-widgets'),
...
function initialize() {
		$this->register_frontend_styles(
			array(
				array(
					'siteorigin-lists',
					siteorigin_widget_get_plugin_dir_url( 'lists' ) . 'css/style.css',
					array(),
					SOW_BUNDLE_VERSION
				)
			)
...
siteorigin_widget_register('lists', __FILE__);