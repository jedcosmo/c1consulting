...
class SiteOrigin_Widget_MoreServices_Widget extends SiteOrigin_Widget {
			...
			array(			
				'services' => array(
					...
					'fields' => array(
						...
						'active' => array(
						'type' => 'checkbox',
						'label' => __('Set Active', 'siteorigin-widgets'),
						'default' => false,
					),
					),
				),
				...
				'icon_animation' => array(
					...
					'options' => array(
						'1' => __('Service Style 1(BOX LAYOUT)', 'siteorigin-widgets'),
						'2' => __('Service Style 2(NO DESCRIPTION)', 'siteorigin-widgets'),	
						'3' => __('Service Style 3', 'siteorigin-widgets'),						
					)
				),
	...
	function initialize() {
		$this->register_frontend_styles(
			array(
				array(
					'siteorigin-moreservices',
					siteorigin_widget_get_plugin_dir_url( 'moreservices' ) . 'css/style.css',
					array(),
					SOW_BUNDLE_VERSION
				)
			)
...
siteorigin_widget_register('moreservices', __FILE__);