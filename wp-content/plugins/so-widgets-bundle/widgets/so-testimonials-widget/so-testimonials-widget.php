			...
			array(
				...
				'testimonials' => array(
					...
					'fields' => array(
						...
						'company' => array(
							'type' => 'text',
							'label' => __('Company Name', 'siteorigin-widgets')
						),
				...
				'style' => array(
					'type' => 'select',
					'label' => __('Testimonial Style', 'siteorigin-widgets'),
					'options' => array(
						'1' => __('Testimonial style 1 ', 'siteorigin-widgets'),
						'2' => __('Testimonial style 2', 'siteorigin-widgets'),	
